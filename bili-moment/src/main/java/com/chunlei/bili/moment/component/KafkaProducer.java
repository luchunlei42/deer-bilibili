...
public class KafkaProducer {
    ...
    public void sendMessage(String topic, String msg, long timestamp){
        ListenableFuture<SendResult<String, String>> future = kafkaTemplate.send(topic, null, timestamp, null, msg);
